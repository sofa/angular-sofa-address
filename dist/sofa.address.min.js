 ...
 */
!function(a){a.module("sofa.address.templates",["sofa-address.tpl.html"]),a.module("sofa-address.tpl.html",[]).run(["$templateCache",function(a){a.put("sofa-address.tpl.html",'<address class="sofa-address">\n    <span class="sofa-address__name">{{data.firstName}} {{data.lastName}}</span>\n    <span class="sofa-address__company">{{data.company}}</span>\n    <span class="sofa-address__street">{{data.street}} {{data.streetNumber}}</span>\n    <span class="sofa-address__street" ng-if="data.streetExtra">{{data.streetExtra}}</span>\n    <span class="sofa-address__city">{{data.zip}} {{data.city}}</span>\n    <span class="sofa-address__country">{{data.country.label}}</span>\n</address>\n')}]),a.module("sofa.address",["sofa-address.tpl.html"]),a.module("sofa.address").directive("sofaAddress",function(){"use strict";return{restrict:"E",replace:!0,scope:{data:"="},templateUrl:"sofa-address.tpl.html"}})}(angular);